...
unsigned int RPM = 0;           //
int porcentagem_anterior = 0;
int porcentagem_atual = 0;
//-------------------------------------------------------------------------------------------------------------------------
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void setup() {
  Serial.begin(115200);
...
void getSerialInput() {
  ...
  porcentagem_atual = incomingByte;
  if (incomingByte >= 0 && (porcentagem_atual - porcentagem_anterior <= 10)) {
    getMotorSpeed();
    porcentagem_anterior = porcentagem_atual;
